...
parser.add_argument('--src_dir', default='/workspace/SIDD/train', type=str, help='Directory for full resolution images')
parser.add_argument('--tar_dir', default='/workspace/Datasets/train', type=str, help='Directory for image patches')
